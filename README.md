...
- You can import our custom files below into your mediawiki instance
    ...
    - <details> <summary> common.js [FR]</code> </summary>
      ...
      */
      ...
      // Hook into the VisualEditor initialization
      mw.hook('ve.activationComplete').add(function (veTarget) {
          // Listen for the linkSearch event
          veTarget.surface.on('linkSearch', function (query) {
              if (query && query.trim() !== '') {
                  // Redirect the query to Wikipedia
