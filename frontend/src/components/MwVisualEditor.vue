...
const $q = useQuasar();
const articleLink = `${process.env.MEDIAWIKI_ENDPOINT}/w/index.php/${props.article.article_id}?veaction=edit&expectedTitle=${props.article.title}&uselang=${props.article.language}`;
