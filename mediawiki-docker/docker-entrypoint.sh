...
echo "Mediawiki admin user: $MW_ADMIN_USER" >> /tmp/MW_CREDENTIALS.txt
echo "Mediawiki admin password: $MW_ADMIN_PASSWORD" >> /tmp/MW_CREDENTIALS.txt
echo "Mediawiki BotPassword user: $BOT_USERNAME" >> /tmp/MW_CREDENTIALS.txt
echo "Mediawiki BotPassword password: $BOT_PASSWORD" >> /tmp/MW_CREDENTIALS.txt
